...
import { steamTopSellers, steamNewReleases, steamSpecials, steamComingSoon, steamTopSellersUS, steamTopSellersJP } from './steam'
...
export const allSources: NewsSource[] = [
  ...
  gameFromScratch, indieGamesPlus,
  raphKoster, danFelder, chaoticStupid, maniaHero, playTank, jgallant, necromanov,
  /* Steam */
  steamTopSellers, steamNewReleases, steamSpecials, steamComingSoon,
  steamTopSellersUS, steamTopSellersJP,
  /* 中文 */
  gcores, youxituoluo, youxichaguan, indienova, gameLook,
  blogOwleat, blogLiuwenyi, codingnow, zengrong,
  /* 日文 */
  fourGamer, automaton, denfaminicogamer, insideGames,
  gamemakers, indieGamesJapan, igdaJapan, indieGamesJpDev,
  hysblog, arashiyama, osakanaLabo,
]
