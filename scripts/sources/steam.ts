...
async function fetchSteamCategory(cc: string, category: string): Promise<NewsItem[]> {
  try {
    const data = await fetchJSON<any>('https://store.steampowered.com/api/featuredcategories?cc=' + cc)
