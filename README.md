...
| 网址 | 203 个 | 203 条 | 无 RSS 的工具/引擎/资源/社区分类链接 |
...
| 语言 | 源数 | 代表性源 |
|------|------|---------|
| English | 约 110 | GamesIndustry.biz、Unity Blog、Godot Blog、GDC、80 Level、GameFromScratch 等 |
| 中文 | 约 12 | 机核网、游戏陀螺、触乐、Indienova、GameLook、Necromanov 等 |
| 日文 | 约 9 | 4Gamer.net、AUTOMATON、電ファミニコゲーマー、GameMakers 等 |
